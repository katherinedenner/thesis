...
The selected transducers were \todo{number} MHz. The fast-charge cells are quite thin, and lithium plating on their electrode would create a thickness of \todo{calc}. 
...
\subsection{Focal Zone}
		...
		\begin{enumerate} 
	        ...
	        \todo{focal zones of 2.5MHz, 10MHz, 15MHz}
	        \todo{oly 46}
	    \end{enumerate}
