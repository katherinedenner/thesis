...
Simultaneously, the Neware cycler unit is using a standard four-lead set-up to both cycle a load on the cell and to monitor the cell's state. The cycler sends a signal through the leads of the cell via one pair of leads, and uses a second pair of leads to read the cell's current and voltage. Timestamps connect this electrochemical data with the acoustic data.
